...
Meteor.publish('userStory', function () {
    ...
    return [
        ...
        Spielbuch.StoredFunctions.find(userOrGlobal, {
            fields: {fncString: 1, userId: 1}
        }),
        Spielbuch.Players.find(userOrGlobal, {
